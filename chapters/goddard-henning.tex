...
\begin{center}
  ...
  \node [block, double, double distance=1pt, text width=50mm] (conj){
    $G$ has total domatic number at least $2$. (Conjecture \ref{conj})
  };
  \node [block, text width=50mm] (bipartite)
    [below=15mm of conj]{
  ...
  \node [block, text width=50mm] (forest)
    [left=15mm of bipartite]{
    There exists a forest in $G$ containing at least one edge from each wheel.
    (Statement \ref{s:forest})
  };
  \node [block, text width=50mm] (no_iso)
    [right=15mm of bipartite]{
  ...
  \node [block, text width=50mm] (dual)
    [below=15mm of bipartite]{
  ...
  \node [block, text width=50mm] (dual_comp)
    [below=15mm of dual]{
